    ...
    es: {
        investorDeck: {
            hero: {
                ...
                ask: "Investment Ask: 100K€ @ 1M€ Post-money",
            },
            moat: {
                ...
                items: [
                    {
                        ...
                        desc: "Análisis de ADN de marca y perfil de cliente para selecciones musicales con ROI garantizado.",
                        icon: BrainCircuit,
                    },
                    {
                        title: "Sustitución Automática",
                        desc: "Motor agentic que reasigna talento en tiempo real ante cancelaciones, eliminando riesgo operativo.",
                        icon: Zap,
                    },
                ],
            },
            ...
            market: {
                ...
                markets: [
                    {
                        icon: "🎵",
                        title: "Live Music Global",
                        val1: "$38.2B",
                        sub1: "Mercado 2025",
                        val2: "$91.4B",
                        sub2: "Music Tourism 2024",
                    },
                    {
                        icon: "🏨",
                        title: "Hospitality España",
                        val1: "97M",
                        sub1: "Turistas 2025",
                        val2: "€4.2B",
                        sub2: "Inversión Hotelera",
                    },
                ],
            },
            team: {
                ...
                members: [
                    {
                        ...
                        role: "Founder & CEO",
                        bio: "Experto en producción musical e innovación digital con visión 360° del sector.",
                    },
                    {
                        name: "Lucas Minetti",
                        role: "Head of Product",
                        bio: "Diseñador gráfico con 10+ años en UX/UI y especializacion en experiencias digitales.",
                    },
                    {
                        name: "Nik Levenberg",
                        role: "Strategic Partner (US)",
                        bio: "25 años de experiencia en tecnología, startups y desarrollo de capital de riesgo.",
                    },
                    {
                        name: "Juan Parodi",
                        role: "Strategic Partner",
                        bio: "Asesor en estructura financiera y go-to-market con visión de expansión.",
                    },
                ],
            },
            investment: {
    ...
    en: {
        investorDeck: {
            hero: {
                ...
                ask: "Investment Ask: 100K€ @ 1M€ Post-money Valuation",
            },
            moat: {
                ...
                items: [
                    {
                        title: "Booking Intelligence",
                        desc: "Brand DNA analysis and customer profiling for music selection with guaranteed ROI.",
                        icon: BrainCircuit,
                    },
                    {
                        title: "Automatic Substitution",
                        desc: "Agentic engine that reassigns talent in real-time during cancellations, eliminating operational risk.",
                        icon: Zap,
                    },
                ],
            },
            ...
            market: {
                ...
                markets: [
                    ...
                    {
                        icon: "🏨",
                        title: "Spain Hospitality",
                        val1: "97M",
                        sub1: "Tourists 2025",
                        val2: "€4.2B",
                        sub2: "Hotel Investment",
                    },
                ],
            },
            team: {
                ...
                members: [
                    {
                        name: "Nicolás Civatti",
                        role: "Founder & CEO",
                        bio: "Expert in music production and digital innovation with 360° sector vision.",
                    },
                    {
                        name: "Lucas Minetti",
                        role: "Head of Product",
                        bio: "Graphic designer with 10+ years in UX/UI and digital experience specialization.",
                    },
                    {
                        name: "Nik Levenberg",
                        role: "Strategic Partner (US)",
                        bio: "25 years of experience in technology, startups and venture capital development.",
                    },
                    {
                        name: "Juan Parodi",
                        role: "Strategic Partner",
                        bio: "Advisor in financial structure and go-to-market with expansion vision.",
                    },
                ],
            },
            investment: {
        ...
        <div className="min-h-screen bg-[#000000] text-white selection:bg-blue-500/30 overflow-x-hidden">
            ...
            <section className="relative pt-32 pb-20 px-6 overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-400 text-[10px] font-medium uppercase tracking-widest mb-8">
                        <Target className="w-3 h-3" /> {content.hero.badge}
                    </div>

                    <h1 className="text-5xl md:text-7xl mb-8 leading-[0.95] font-black">
                        {content.hero.title.split("\n").map((line, i) => (
                            <div key={i}>
                                {line.includes("infraestructura") || line.includes("Infrastructure") ? (
                                    <>
                                        {line.split("infraestructura" || "Infrastructure")[0]}
                                        <span className="text-blue-500">
                                            {line.includes("infraestructura") ? "infraestructura" : "Infrastructure"}
                                        </span>
                                    </>
                                ) : (
                                    line
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <h2 className="text-4xl md:text-5xl mb-8 font-black">{content.moat.title}</h2>

                            <div className="space-y-8">
                                {content.moat.items.map((item, i) => (
                                    <MoatCard
                                        key={i}
                                        Icon={item.icon}
                                        title={item.title}
            ...
            <section className="py-32 max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-bold mb-4">{content.market.title}</h2>
                    <p className="text-slate-400">{content.market.subtitle}</p>
                </div>

                <div className="grid md:grid-cols-2 gap-8">
                    {content.market.markets.map((m, i) => (
            ...
            <section className="py-32 max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-bold mb-4">
                        {locale === "es" ? "Roadmap de Crecimiento" : "Growth Roadmap"}
                    </h2>
            ...
            <section className="py-32 max-w-7xl mx-auto px-6">
                <div className="grid lg:grid-cols-2 gap-16">
                    <div>
                        <h2 className="text-4xl font-bold mb-8">{content.investment.title}</h2>

                        <div className="space-y-4 mb-12">
                            {content.investment.terms.map((term, i) => (
                        ...
                        <h4 className="font-bold text-lg mb-4">
                            {locale === "es" ? "Uso de Fondos" : "Use of Funds"}
                        </h4>
                        <ul className="space-y-3">
                            {content.investment.usage.map((u, i) => (
                    ...
                    <div className="relative">
                        <div className="sticky top-20 p-8 rounded-3xl bg-gradient-to-b from-blue-600/20 to-purple-600/10 border border-white/10">
                            ...
                            <h3 className="text-2xl font-bold mb-4">
                                {locale === "es" ? "Oportunidad de Inversión" : "Investment Opportunity"}
                            </h3>
                            <div className="space-y-4">
                                <div>
                                    <div className="text-sm text-slate-400">Valuación Post-Money</div>
                                ...
                                <div>
                                    <div className="text-sm text-slate-400">Inversión Inicial</div>
            ...
            <section className="py-20 px-6 text-center bg-gradient-to-t from-blue-600/20 to-transparent">
                ...
                <div className="flex gap-4 justify-center flex-col sm:flex-row">
                    ...
                    >
                        {content.cta.button} <ArrowRight className="w-4 h-4" />
                    </Link>
                </div>
            </section>
            ...
            <div className="fixed bottom-4 right-4 text-[10px] text-slate-600 pointer-events-none opacity-50">
                {locale === "es" ? "Presentación privada" : "Private Presentation"}
            </div>
        </div>
    );
}